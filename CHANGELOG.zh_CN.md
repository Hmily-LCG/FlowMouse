...
**手势改进：**
- 关闭标签页命令支持保留标签页（仅关闭页面内容）

**界面及更多改进：**
- 清理代码，减小扩展程序体积
- 修复扩展程序安装/更新后部分标签页刷新前可能无法使用手势的问题
- 其他细节改进
...
**区域框选改进：**
- 支持设置在区域框选后自动执行操作
- 修复框选时按下 ESC 键取消框选时，悬浮栏显示的链接计数不准确的问题
- 对于通过手势触发的区域框选，支持单独设置不同手势的区域框选的行为

**界面及更多改进：**
- 修复命令链执行时打开新窗口后，后续操作仍在以前的窗口执行的问题
- 完善设置界面细节，部分输入框添加图标
- 其他细节改进
...
- 优化设置等页面的打开速度
- 优化滚动逻辑，修复少数网站无法滚动的问题
- 修复少数网站样式可能干扰扩展程序 ShadowDOM 的问题
- 修复恢复默认设置后，已打开的标签页未同步生效的问题
- 修复区域框选无法设置关闭批量操作提醒的问题
- 修复第三方新标签页扩展程序可能会干扰拖拽搜索功能的问题（感谢 @realDGD ）
- 修复同步设置后，因 Chrome 浏览器不同设备间书签目录 ID 不一致可能导致书签功能失效的问题
- 优化操作提示显示逻辑，避免被第三方广告拦截扩展程序误拦截
- 修复关闭自定义手势功能后，操作提示仍会显示自定义名称的问题
- 其他细节改进
