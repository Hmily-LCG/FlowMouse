(function () {
	...
	const DEFAULT_SETTINGS = {
		...
		enableAutoScrollMode: false,
        autoScrollMode: {
            style: 'pan',
            left:  { enabled: true, scrollDistance: 75, scrollAccel: 1 },
            right: { enabled: true, scrollDistance: 75, scrollAccel: 1 },
            up:    { enabled: true, scrollDistance: 75, scrollAccel: 1 },
            down:  { enabled: true, scrollDistance: 75, scrollAccel: 1 },
        },
